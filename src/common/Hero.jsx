...
const Hero = () => {
    return (
        <section className="bg-center bg-no-repeat  bg-gray-400 bg-blend-multiply hero">
            <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Tu y penses, Nous le réalisons!</h1>
                <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Concours</p>
